...
* IaaS API Identity is a service required to use object storage. For more detailed description, refer to [**User Guide > Storage > Object Storage > API Guide > Authentication Token Issuance**](https://docs.toast.com/en/Storage/Object%20Storage/en/api-guide/).
